...
<div id="page_wrapper" ng-controller="pageCtrl">
                    ...
                    <tr data-id="<?=$item->id?>">
                        ...
                        <td>
                            <?php if($item->filename){ ?>
                                <img src="<?=$this->m->config->assets_url.DS.'people'?>/<?=$item->filename?>">
                            <?php }?>
                        </td>
                        <td>
    ...
    <script>
        app.controller('confirmationCtrl', ['$scope','$http',function($scope,$http){
