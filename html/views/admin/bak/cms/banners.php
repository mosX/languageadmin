<script>
    app.controller('pageCtrl', ['$scope','$http',function($scope,$http,$userinfo){
        ...
        $scope.deleteBanner = function(){
             $http({
                url:'/cms/delete_banner/?id='+$scope.banner_id,
                method:'GET',
            }).then(function(ret){
            ...
            <table class="table">
                ...
                <?php foreach ($this->m->data as $item) { ?>
                    <tr data-id="<?=$item->id?>">
                        ...
                        <td>
                            <a ng-click="editForm($event,<?=$item->id?>)" class="edit_tags_ico" title="Редактировать Баннер" href=""></a>
                            <a ng-click="deleteBannerConfrimation($event,<?=$item->id?>,'<?=$item->name?>')" title="Удалить Баннер" class="del_user_ico" href=""></a>
                        </td>
                    </tr>
                <?php } ?>
            </table>
