<div id="page_wrapper">
    ...
    <?= $this->m->module('topmenu/epg_programs_top_menu') ?>
            ...
            <table class="table">
                ...
                <?php foreach ($this->m->data as $item) { ?>
                    <tr data-id="<?=$item->id?>">
                        ...
                        <td style="overflow:hidden;text-overflow:ellipsis" title="<?=$item->title?>"><?=$item->title?></td>
                        <td style="overflow:hidden;text-overflow:ellipsis" title="<?=$item->description?>"><?=$item->description?></td>
                        <td><?=$item->category?></td>
                        <td><?=$item->start?></td>
                        <td><?=$item->stop?></td>
                    </tr>
