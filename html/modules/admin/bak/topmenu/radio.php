<div id="top_menu">
    ...
    <div class="page_menu">
        <div class="preset">
            <div class='title_button'>RADIO</div>        
        </div>

        <div class="actions">
            <a data-toggle="modal" data-target="#addEPGModal"   class="button add_deal">+ НОВОЕ РАДИО</a>
        </div>
                    ...
                    <div class="row">
                        <div class="col-sm-5">
                            <div class="form-group">
                                ...
                                <div class="col-sm-4">
                                    <input type="text" name="date_from" class="datepicker form-control" value="">
                                </div>
                                <div class="col-sm-4">
                                    <input type="text" name="date_to" class="datepicker form-control" value="">
                                </div>
                            </div>
...
<script>
    app.controller('radioModalCtrl', ['$scope','$http',function($scope,$http,$userinfo){
        $scope.form = {};
        console.log('START');
...
<div ng-controller="radioModalCtrl" class="modal fade" id="addRadioModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title font-header"><p><strong>Добавить Новое Радио</strong></p></h4>
            </div>
...
<script>
    app.controller('radioEditModalCtrl', ['$scope','$http',function($scope,$http,$userinfo){
        $scope.form = {};
        console.log('START');
        $scope.submit = function(event){
            $http({
...
<div ng-controller="radioEditModalCtrl" class="modal fade" id="radioeditEPGModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" data-dismiss="modal">×</button>
