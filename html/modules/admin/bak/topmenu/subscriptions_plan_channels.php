<div id="top_menu">
    ...
    <div class="page_menu">
        <div class="preset">
            <div class='title_button'>Каналы Пакета</div>
        </div>
        ...
        <div class="actions">
            <div data-toggle="modal" data-target="#addModal" class="button add_deal">+ ДОБАВИТЬ КАНАЛ</div>
        </div>
    </div>
</div>
                        ...
                        <div class="row">                            
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">                                        
                                        <select class="form-control" ng-model="form.channel">
