<div id="top_menu">
    ...
    <div class="page_menu">
        <div class="preset">
            <div class='title_button'>Пушы</div>
        </div>
        ...
        <div class="actions">
            ...
            <div data-toggle="modal" data-target="#addPushModal" class="button add_deal">+ НОВЫЙ ПУШ</div>
        </div>
    </div>
</div>

<script>
    app.controller('pushEditModalCtrl', ['$scope','$http',function($scope,$http,$userinfo){
        $scope.$on('editData',function(e,ret){
            console.log(ret);
            $('#pushEditModal').modal('show');
            $scope.form = ret.data;
        })
...
<div ng-controller="pushEditModalCtrl" class="modal fade" id="genresEditModal" tabindex="-1" role="dialog">
...
<script>
    app.controller('addPushModalCtrl', ['$scope','$http',function($scope,$http,$userinfo){        
        $scope.form = {};
...
<div ng-controller="addPushModalCtrl" class="modal fade" id="addPushModal" tabindex="-1" role="dialog">
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                <button class="close" data-dismiss="modal">×</button>
                <h4 class="modal-title font-header"><p><strong>Добавить Пуш</strong></p></h4>
            </div>
                        ...
                        <div class="row">                            
                            <div class="form-group">
                                <div class="row">
                                    ...
                                    <div class="col-sm-8">
                                        <input type="text" class="form-control" name="name" ng-model="form.title">
                                    </div>
                                </div>                                
                            </div>
