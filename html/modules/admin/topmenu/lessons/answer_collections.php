<div id="top_menu">
    ...
    <div class="page_menu">
        <div class="preset">
            <div class='title_button'>Коллекция Ответов</div>
        ...
        <div class="actions">
            ...
            <a data-toggle="modal" data-target="#addAnswerModal" class="button add_deal">+ Добавить Ответ</a>
        </div>
    </div>
</div>
<!--
                ...
                <form action="" method="POST" ng-submit="submit($event)">
                    <div class="form-group">
                        <div class="row">
                            ...
                            <div class="col-sm-8">
                                <select class="form-control" ng-model="form.answer">
                                    <option value="0">Ответы</option>
                    ...
                    <input value="Добавить" class="btn btn-primary" type="submit" style="margin-bottom:15px;">
                </form>
            </div>
        </div>
    </div>
