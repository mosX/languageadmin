<div id="top_menu">
    ...
    <div class="page_menu">
        <div class="preset">
            <div class='title_button'>Список Студентов</div>
        ...
        <div class="actions">          
            <a href="" data-toggle="modal" data-target="#addModal" class="button add_deal">+ ДОБАВИТЬ СТУДЕНТА</a>
        </div>
    </div>
</div>
    ...
    <div class="modal-dialog" role="document">
        <div class="modal-content">
            <div class="modal-header">
                ...
                <h4 class="modal-title font-header"><p><strong>Добавить студента</strong></p></h4>
            </div>
...
<script>
    app.controller('deleteModalCtrl', ['$scope', '$http', function ($scope, $http) {
        ...
        $scope.submit = function(event){
            ...
            $http({
                url:'/tasktable/delete_student/?id='+$scope.id,
                method:'GET'
            }).then(function(ret){
                if(ret.data.status == 'success'){
                    location.href = location.href;
